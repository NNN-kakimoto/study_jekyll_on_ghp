...
なお、このアドレスをアドレスをリポジトリトップの
code / issue ...
って並んでるすぐ下、『Edit』ボタン押した先で設定しておくと自分も開きやすくて便利です。
...
例えば、アプリ直下(README.mdの隣)に`sub_page.md`みたいなのを作ると、`https://<GitHub_ID>/github.io/<リポジトリ名>/sub_page`というアドレスで公開されます。
